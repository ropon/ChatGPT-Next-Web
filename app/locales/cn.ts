...
const cn = {
  ...
  Mcp: {
    ...
    Market: {
      Title: "MCP 市场",
      SubTitle: (count: number) => `已配置 ${count} 个服务器`,
    ...
    Toast: {
      ConfigUpdated: "服务器配置更新成功",
      SaveFailed: "保存配置失败",
      LoadFailed: "加载工具失败",
      ServerStopped: "服务器停止成功",
      StopFailed: "停止服务器失败",
      StartFailed: "启动服务器失败，请检查日志",
      ServerRemoved: "服务器移除成功",
      RemoveFailed: "移除服务器失败",
      RestartingAll: "正在重启所有客户端",
      RestartFailed: "重启客户端失败",
      LoadPresetFailed: "加载预设服务器失败",
      RuntimeSaved: "运行时配置已保存，请重启服务器以应用更改。",
      RuntimeSaveFailed: "保存运行时配置失败",
      PathsDetected: "路径检测成功",
      PathsDetectFailed: "检测路径失败",
      ServerAdded: "服务器添加成功",
      ServerUpdated: "服务器更新成功",
      ServerSaveFailed: "保存服务器失败",
      EnterServerId: "请输入服务器 ID",
      EnterCommand: "请输入命令",
      EnterUrl: "请输入 URL",
      ServerIdConflict: "服务器 ID 与预设服务器冲突",
    },
    Modal: {
      ConfigureServer: "配置服务器",
      ServerDetails: "服务器详情",
      AddCustomServer: "添加自定义 MCP 服务器",
      EditServer: "编辑服务器",
    ...
    CustomServer: {
      ServerId: "服务器 ID",
      ServerIdDesc: "此服务器的唯一标识符 (例如: my-mcp-server)",
      ServerIdPlaceholder: "my-mcp-server",
      Type: "类型",
      TypeDesc: "服务器连接类型",
      Command: "命令",
      CommandDesc: "可执行命令 (例如: npx, uvx, node, python)",
      CommandPlaceholder: "npx",
      Arguments: "参数",
      ArgumentsDesc:
        "空格分隔的参数 (例如: -y @modelcontextprotocol/server-filesystem /path)",
      ArgumentsPlaceholder: "-y @modelcontextprotocol/server-filesystem /path",
      EnvVars: "环境变量",
      EnvVarsDesc: "每行一个，格式: KEY=VALUE",
      EnvVarsPlaceholder: "API_KEY=your-api-key\nDEBUG=true",
      Url: "URL",
      UrlDesc: "SSE 服务器端点 URL",
      UrlPlaceholder: "https://mcp.example.com/sse",
      Headers: "请求头",
      HeadersDesc: "HTTP 请求头 (每行一个，格式: KEY=VALUE)",
      HeadersPlaceholder: "Authorization=Bearer xxx\nX-API-Key=your-key",
    },
    Runtime: {
      NodePath: "Node.js 路径",
      NodePathDesc: "node 可执行文件的完整路径 (例如: /usr/local/bin/node)",
      NodePathPlaceholder: "/usr/local/bin/node",
      NpxPath: "npx 路径",
      NpxPathDesc: "npx 可执行文件的完整路径 (例如: /usr/local/bin/npx)",
      NpxPathPlaceholder: "/usr/local/bin/npx",
      UvxPath: "uvx 路径",
      UvxPathDesc: "uvx 可执行文件的完整路径 (例如: ~/.local/bin/uvx)",
      UvxPathPlaceholder: "~/.local/bin/uvx",
      ExtraPath: "额外 PATH",
      ExtraPathDesc: "搜索可执行文件的额外目录 (冒号分隔)",
      ExtraPathPlaceholder: "/opt/homebrew/bin:/usr/local/bin",
      Hint: "如果 MCP 服务器启动失败，请配置可执行文件路径。点击'自动检测'自动查找常用路径。保存后需重启服务器以应用更改。",
    },
  },
  FineTuned: {
    Sysmessage: "你是一个助手",
