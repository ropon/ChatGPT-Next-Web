...
const en: LocaleType = {
  ...
  Mcp: {
    ...
    Market: {
      ...
      PresetServers: "Preset Servers",
      Custom: "Custom",
      RestartAll: "Restart All",
      Loading: "Loading...",
      LoadingPreset: "Loading preset server list...",
    ...
    Status: {
      ...
      Removing: "Removing server...",
      Restarting: "Restarting all servers...",
    },
    Toast: {
      ConfigUpdated: "Server configuration updated successfully",
      ...
      RestartingAll: "Restarting all clients",
      RestartFailed: "Failed to restart clients",
      LoadPresetFailed: "Failed to load preset servers",
      RuntimeSaved: "Runtime configuration saved. Restart servers to apply.",
      RuntimeSaveFailed: "Failed to save runtime configuration",
      PathsDetected: "Paths detected successfully",
      PathsDetectFailed: "Failed to detect paths",
      ServerAdded: "Server added successfully",
      ServerUpdated: "Server updated successfully",
      ServerSaveFailed: "Failed to save server",
      EnterServerId: "Please enter a server ID",
      EnterCommand: "Please enter a command",
      EnterUrl: "Please enter a URL",
      ServerIdConflict: "Server ID conflicts with preset server",
    },
    Modal: {
      ConfigureServer: "Configure Server",
      ServerDetails: "Server Details",
      AddCustomServer: "Add Custom MCP Server",
    ...
    CustomServer: {
      ServerId: "Server ID",
      ServerIdDesc: "Unique identifier for this server (e.g., my-mcp-server)",
      ServerIdPlaceholder: "my-mcp-server",
      Type: "Type",
      TypeDesc: "Server connection type",
      Command: "Command",
      CommandDesc: "Executable command (e.g., npx, uvx, node, python)",
      CommandPlaceholder: "npx",
      Arguments: "Arguments",
      ArgumentsDesc:
        "Space-separated arguments (e.g., -y @modelcontextprotocol/server-filesystem /path)",
      ArgumentsPlaceholder: "-y @modelcontextprotocol/server-filesystem /path",
      EnvVars: "Environment Variables",
      EnvVarsDesc: "One per line, format: KEY=VALUE",
      EnvVarsPlaceholder: "API_KEY=your-api-key\nDEBUG=true",
      Url: "URL",
      UrlDesc: "SSE server endpoint URL",
      UrlPlaceholder: "https://mcp.example.com/sse",
      Headers: "Headers",
      HeadersDesc: "HTTP headers (one per line, format: KEY=VALUE)",
      HeadersPlaceholder: "Authorization=Bearer xxx\nX-API-Key=your-key",
    },
    Runtime: {
      NodePath: "Node.js Path",
      NodePathDesc: "Full path to node executable (e.g., /usr/local/bin/node)",
      NodePathPlaceholder: "/usr/local/bin/node",
      NpxPath: "npx Path",
      NpxPathDesc: "Full path to npx executable (e.g., /usr/local/bin/npx)",
      NpxPathPlaceholder: "/usr/local/bin/npx",
      UvxPath: "uvx Path",
      UvxPathDesc: "Full path to uvx executable (e.g., ~/.local/bin/uvx)",
      UvxPathPlaceholder: "~/.local/bin/uvx",
      ExtraPath: "Extra PATH",
      ExtraPathDesc:
        "Additional directories to search for executables (colon-separated)",
      ExtraPathPlaceholder: "/opt/homebrew/bin:/usr/local/bin",
      Hint: 'Configure paths to executables if MCP servers fail to start. Click "Auto Detect" to automatically find common paths. Restart servers after saving to apply changes.',
    },
  },
  FineTuned: {
